/*
  pins_arduino.h - Pin definition functions for MegaCore
  This file will only work with the ATmega640, ATmega1280 and ATmega2560
  File created by MCUdude
  https://github.com/MCUdude/MegaCore

  This pin definition file is an alternative to the well known
  Arduino MEGA pinout. This "new" pinout is more ideal if you're
...
// PCINT defs
#define digitalPinToPCICR(p)    ((((p) >= 15) && ((p) <= 22)) || \
                                 (((p) >= 52) && ((p) <= 58)) || \
                                 (((p) >= 77) && ((p) <= 84)) || \
                                  ((p) ==  0) ? (&PCICR) : ((uint8_t *)0) )
