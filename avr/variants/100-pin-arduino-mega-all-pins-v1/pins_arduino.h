...
const uint8_t PROGMEM digital_pin_to_timer_PGM[] = {
	...
	NOT_ON_TIMER	, // PK 7 ** 69 ** A15
        NOT_ON_TIMER	, // PJ 7 ** 85 ** D70
        NOT_ON_TIMER	, // PE 6 ** 71 ** D71
        NOT_ON_TIMER	, // PE 7 ** 72 ** D72
        NOT_ON_TIMER	, // PH 2 ** 73 ** D73
        NOT_ON_TIMER	, // PG 3 ** 75 ** D75
        NOT_ON_TIMER	, // PJ 6 ** 84 ** D76
        NOT_ON_TIMER	, // PJ 5 ** 83 ** D77
        NOT_ON_TIMER	, // PJ 4 ** 82 ** D78
        NOT_ON_TIMER	, // PJ 3 ** 81 ** D79
        NOT_ON_TIMER	, // PJ 2 ** 80 ** D80
        NOT_ON_TIMER	, // PD 6 ** 79 ** D81
        NOT_ON_TIMER	, // PD 5 ** 78 ** D82
        NOT_ON_TIMER	, // PD 4 ** 77 ** D83
        NOT_ON_TIMER	, // PG 4 ** 76 ** D84
        NOT_ON_TIMER	, // PE 2 ** 70 ** D85
        NOT_ON_TIMER	, // PH 7 ** 74 ** D86
};
